...
# estudo_kedro_spaceflights documentation build
...
from estudo_kedro_spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "estudo_kedro_spaceflights"
author = "Kedro"
...
htmlhelp_basename = "estudo_kedro_spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "estudo_kedro_spaceflights.tex",
        "estudo_kedro_spaceflights Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "estudo_kedro_spaceflights",
        "Project estudo_kedro_spaceflights codebase.",
        "Data-Science",
    )
]
